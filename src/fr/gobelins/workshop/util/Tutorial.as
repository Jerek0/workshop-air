...
import fr.gobelins.workshop.util.slider.DotsContainer;
    ...
    public class Tutorial extends Sprite {
        ...
        private function _onAddedToStage(event:Event):void {
            var overlay:Quad = new Quad(stage.stageWidth, stage.stageHeight, 0x000000);
            overlay.alpha = 0.8;
            ...
            var dots:DotsContainer = new DotsContainer(tutoriel, App.assets.getTexture("dotActive"),App.assets.getTexture("dotInactive"));
